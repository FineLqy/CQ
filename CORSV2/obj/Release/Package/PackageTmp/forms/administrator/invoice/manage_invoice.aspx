<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manage_invoice.aspx.cs" Inherits="CORSV2.forms.administrator.invoice.manage_invoice" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>平台用户发票管理</title>
...
<body class="gray-bg">
    ...
    <script>
        ...
        function verify(id)
        {
            layer.confirm('请对该发票进行审核，通过或者拒绝', {
                btn: ['通过', '拒绝'], //按钮
                closeBtn: 0,
                shadeClose: true, //开启遮罩关闭 
            }, function () {
                //layer.msg('的确很重要', { icon: 1 });
                $.get('/forms/administrator/invoice/manage_invoice.aspx?verify=' + id, { "status": "OK" }, function () {
                    layer.msg('已通过，请及时上传发票', { icon: 1 });
                    table.bootstrapTable('refresh');
                });
            }, function () {
                $.get('/forms/administrator/invoice/manage_invoice.aspx?verify=' + id, { "status": "NO" }, function () {
        ...
        function uploadfile(id) {
            parent.layer.open({
                ...
                area: ['1150px', '650px'],
                content: '/forms/administrator/invoice/invoice_detail_info.aspx?action=transferInvoiceListId&id=' + id,
                end: function () {
                    location.reload();
                }
            });
