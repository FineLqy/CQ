<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rtkUserManage_Admin.aspx.cs" Inherits="CORSV2.forms.administrator.users.rtkUserManage_Admin" %>
    ...
    <script>
        ...
        function rtkUserDetailInfoView(id) {
            parent.layer.open({
                ...
                area: ['1150px', '650px'],
                content: '/forms/administrator/users/rtkAdminView.aspx?id=' + id
            });
        }
