<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rtkAdminView.aspx.cs" Inherits="CORSV2.forms.administrator.users.rtkAdminView" %>
<!DOCTYPE html>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseOne1" class="panel-collapse collapse in">
                                        ...
                                        <div>
                                            ...
                                            <input class=" layer-date" id="ssbsks" runat="server" style="width: 20%; height: 20px; vertical-align: top" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({ istime: true, format: 'YYYY-MM-DD hh:mm:ss' })" >
                                            ...
                                            <input class=" layer-date" id="ssbsjs" runat="server" style="width: 20%; height: 20px; vertical-align: top" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({ istime: true, format: 'YYYY-MM-DD hh:mm:ss' })" >
                                            <label class="laydate-icon" style="width: 2%; height: 20px; vertical-align: top"></label>
                                        </div>
                                        <div class="hr-line-dashed"></div>
                                        <div>
                                        ...
                                        <div class="hr-line-dashed"></div>
                                         ...
                                         <div class="hr-line-dashed"></div>
                                        <div>
                                            <label style="width: 12%; text-align: center">漫游区域</label>
                                            <select id="sszyqu1" onchange="changearea1()" runat="server" style="background-color: #FFFFFF; background-image: none; border: 1px solid #e5e6e7; border-radius: 1px; color: inherit; display: normal; width: 10%" >
                                                <option>全部区域</option>
                                            </select>
                                            <label style="width: 10%; text-align: center">是否可用</label>
                                            <select id="sszyqyky1" onchange="changeareaeable1()" runat="server" style="background-color: #FFFFFF; background-image: none; border: 1px solid #e5e6e7; border-radius: 1px; color: inherit; display: normal; width: 10%" >
                                                <option>不可用</option>
                                                <option>可用</option>

                                            </select>
                                            <label style="width: 10%; text-align: center">可用区域</label>
                                            <input type="text" id="sskyqu1" runat="server" readonly="readonly" style="width: 35%; background-color: #e5e6e7; background-image: none; border: 1px solid #e5e6e7; border-radius: 1px; color: inherit; padding-bottom: 2px">
                                        </div>
                                        <div class="hr-line-dashed"></div>

                                        <div>
                                            <label style="width: 12%; text-align: center">正常高获取</label>
                                            <select id="sszcghq" name="sszcghq" runat="server" style="background-color: #FFFFFF; background-image: none; border: 1px solid #e5e6e7; border-radius: 1px; color: inherit; display: normal; width: 35%" >
                                                <option>不可用</option>
                                                <option>可用</option>
  ...
  <%--  <script src="../../../js/plugins/validate/jquery.validate.min.js"></script>
    ...
    <script>
        ...
        function changearea1() {
            sszyqyky1.selectedIndex = 0;
            var area1ky1 = new Array();
            area1ky1 = sskyqu1.value.split(";");
            for (var i = 0; i < area1ky1.length; i++) {
                if (area1ky1[i] == sszyqu1.value) {
                    sszyqyky1.selectedIndex = 1;
                }
            }
        }
        //作业区域可用改变
        function changeareaeable1() {
            var areaid1 = sskyqu1.value;
            if (sszyqyky1.selectedIndex == 1) {
                if (sszyqu1.selectedIndex != 0) {
                    areaid1 += (sszyqu1.value + ";");
                    sskyqu1.value = areaid1.replace("全部区域", "");
                }
                else {
                    sskyqu1.value = "全部区域";
                }
                ...
                sskyqu1.value = areaid1.replace(sszyqu1.value + ";", "");
                if (sskyqu1.value == "") {
                    sskyqu1.value = "全部区域";
                    sszyqyky1.selectedIndex = 1;
                    sszyqu1.selectedIndex = 0;
                }
