<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemOperationLog1.aspx.cs" Inherits="CORSV2.forms.administrator.information.SystemOperationLog1" %>
                ...
                <div class="ibox-content">
                    <div class="bars pull-left">
                        <div id="toolbar">
                            <select id="dataType" class="form-control" onchange="changedata();">
                                <option value="0" selected="selected">用户登录日志</option>
                    ...
                    <div class="boottable">
                        <table id="table"
                            ...
                            data-url="SystemOperationLog1.aspx?action=GetData&dataType=0"
    ...
    <script>
        ...
        function changedata() {
            $('#table').bootstrapTable('refresh', {
                url: "SystemOperationLog1.aspx?action=GetData&dataType=" + $("#dataType").val(),
                silent: true
            });
