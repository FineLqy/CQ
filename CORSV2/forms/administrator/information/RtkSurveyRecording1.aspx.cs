...
{
    public partial class RtkSurveyRecording1 : System.Web.UI.Page
    {
        ...
        private bool GetData()
        {
            try
            {
                ...
                DataSet ds = DAL.RTKSurveyRec.GetListByPage1(offset, limit, Session["UserName"].ToString(), sort, order, search);
        ...
        {
            DataTable dt = DAL.RTKSurveyRec.GetList1(Session["UserName"].ToString()).Tables[0];
