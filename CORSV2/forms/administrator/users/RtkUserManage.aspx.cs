...
{
    public partial class RtkUserManage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet dsaddeditemtype = DAL.RTKUserInfo.GetList1( Session["UserName"].ToString());
                this.SatelliteSystem.DataSource = dsaddeditemtype;
                this.SatelliteSystem.DataTextField = "UserName";
                this.SatelliteSystem.DataValueField = "ID";
                this.SatelliteSystem.DataBind();
            }
            //fd.Visible = false;
            //toolbar.Attributes.CssStyle.Value = "display:none";
        ...
        private bool GetData()
        {
            ...
            ds.Tables[0].Columns.Add("xf", typeof(string));
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                dr["PassWord"] = ""; // AES_Key.AESEncrypt(dr["PassWord"].ToString() , dr["UserName"].ToString().PadLeft(16, '0'));
        ...
        public class Content
        {
            public Content()
            { }
            public Content(string SatelliteSystem, string RenewalDuration)
            {
