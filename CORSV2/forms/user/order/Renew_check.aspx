<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Renew_check.aspx.cs" Inherits="CORSV2.forms.user.order.Renew_check" %>
...
<%--                                    <div><input id="order_number" name="order_number" runat="server" readonly="readonly" disabled="disabled" style.display="block" /></div>--%>
    ...
    <script>
        $("#confirm").click(function () {
            ...
            window.location.href = "pay_Renew.aspx?order_number=" + order_number;
            //$.ajax({
            //    type: "get",
            //    data:{
