                            ...
                            <ul class="centerFormUl" style="padding-top: 0;">
                             ...
                             <%--   服务协议（盖章）”--%>
                                ...
                                <li class="clearfix">
                                    ...
                                    <div class="labelRight" style="width:200px">
                                        <input type="tel" id="contact_phone" name="contact_phone" class="form-control width-300" value="" placeholder="请填写手机号码" runat="server">
...
<%--    <script src="../../../js/plugins/webuploader/webuploader.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        $(".centerBtnCompany").click(function () {
            ...
            //服务协议
            if ($("#Service_agreement_path_file").find("img")[0].src != "") {
                var tt = $("#Service_agreement_path_file").find("img")[0].src;
            }
            else {
                var odiv = document.getElementById("Service_agreement_path_file");
                done(odiv, function (e) {
                ...
                $("#Service_agreement_path_file").siblings('i').show().find('em').html('请上传');
                return false;
            }
